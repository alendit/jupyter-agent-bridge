...
const optionalRevealCellSchema = z
  ...
  .optional()
  .describe(
    "Optional, defaults to false. Set true to scroll the affected cell into view after the edit or execution without changing editor focus or cell selection. For explicit viewport positioning, cell selection, or output focus, use reveal_notebook_cells.",
  );
...
export const TOOL_HELP: Record<ToolName, ToolHelp> = {
  ...
  insert_cell: {
    ...
    schema:
      '{"notebook_uri":"file:///.../demo.ipynb","expected_notebook_version"?:7,"position":{"mode":"before_index","index":0}|{"mode":"before_cell_id","cell_id":"cell-1"}|{"mode":"after_cell_id","cell_id":"cell-1"}|{"mode":"at_end"},"cell":{"kind":"markdown"|"code","source":"...","language"?:string|null,"metadata"?:object},"reveal_cell"?:false}',
    examples: [
      '{"notebook_uri":"file:///workspace/demo.ipynb","position":{"mode":"at_end"},"cell":{"kind":"code","language":"python","source":"print(1)"}}',
      '{"notebook_uri":"file:///workspace/demo.ipynb","position":{"mode":"after_cell_id","cell_id":"cell-1"},"cell":{"kind":"markdown","source":"## Notes"},"reveal_cell":true}',
    ],
  },
  replace_cell_source: {
    ...
    schema:
      '{"notebook_uri":"file:///.../demo.ipynb","cell_id":"cell-1","expected_notebook_version"?:7,"expected_cell_source_fingerprint"?: "<fingerprint>","source":"...","reveal_cell"?:false}',
    examples: [
  ...
  patch_cell_source: {
    ...
    schema:
      '{"notebook_uri":"file:///.../demo.ipynb","cell_id":"cell-1","patch":"..."|[{"old":"...","new":"...","replace_all"?:false}],"format"?: "auto"|"unified_diff"|"codex_apply_patch"|"search_replace_json","expected_notebook_version"?:7,"expected_cell_source_fingerprint"?: "<fingerprint>","reveal_cell"?:false}',
    examples: [
  ...
  format_cell: {
    ...
    schema:
      '{"notebook_uri":"file:///.../demo.ipynb","cell_id":"cell-1","expected_notebook_version"?:7,"expected_cell_source_fingerprint"?: "<fingerprint>","reveal_cell"?:false}',
    examples: [
  ...
  delete_cell: {
    ...
    schema: '{"notebook_uri":"file:///.../demo.ipynb","cell_id":"cell-1","expected_notebook_version"?:7,"reveal_cell"?:false}',
    examples: ['{"notebook_uri":"file:///workspace/demo.ipynb","cell_id":"cell-1","reveal_cell":true}'],
  },
  move_cell: {
    title: "Move Cell",
    summary: "Move one cell to a target index. Mutates notebook.",
    schema:
      '{"notebook_uri":"file:///.../demo.ipynb","cell_id":"cell-1","target_index":0,"expected_notebook_version"?:7,"reveal_cell"?:false}',
  ...
  execute_cells: {
    ...
    schema:
      '{"notebook_uri":"file:///.../demo.ipynb","cell_ids":["cell-1"],"expected_notebook_version"?:7,"expected_cell_source_fingerprint_by_id"?:{"cell-1":"<fingerprint>"},"timeout_ms"?:30000,"stop_on_error"?:true,"reveal_cell"?:false}',
    examples: [
      '{"notebook_uri":"file:///workspace/demo.ipynb","cell_ids":["cell-1"]}',
...
export const NOTEBOOK_RULES = [
  ...
  "Cell-mutating and execution tools (insert_cell, replace_cell_source, patch_cell_source, format_cell, delete_cell, move_cell, execute_cells, execute_cells_async) accept an optional reveal_cell boolean (default false). Pass reveal_cell=true to scroll the editor to the affected cell without changing editor focus or cell selection.",
];

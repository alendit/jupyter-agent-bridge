...
export const NOTEBOOK_OUTPUT_KINDS: OutputKind[] = [
  "text",
  "markdown",
  "json",
  "html",
...
export interface PatchCellSourcePreviewRequest {
...
export type PreviewCellEditRequest = ReplaceCellSourcePreviewRequest | PatchCellSourcePreviewRequest;
